...
describe("Auth (e2e)", () => {
  ...
  describe("signup", () => {
    ...
    it("should return imageUrl when imageBase64 is given", async () => {
      const validPayload: SignupDto = {
  ...
  describe("POST /auth/password-reset", () => {
    it("should return 400 when invalid body", async () => {
      const response = request(app.getHttpServer()).post(
        "/auth/password-reset"
      );
  ...
  describe("GET /auth/password-reset/:token", () => {
    ...
    it("should return 400 when token expired", async () => {
      ...
      const response = await request(app.getHttpServer()).get(
        "/auth/password-reset/" + expiredToken
      );
    ...
    it("should return 200 when valid token", async () => {
      ...
      const response = await request(app.getHttpServer()).get(
        "/auth/password-reset/" + validToken
      );
